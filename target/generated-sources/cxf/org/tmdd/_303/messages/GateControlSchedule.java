 ...
 * 
 * 
 * <p>Java class for GateControlSchedule complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GateControlSchedule"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="device-control-schedule-header" type="{http://www.tmdd.org/303/messages}DeviceControlScheduleHeader"/&gt;
 *         &lt;element name="gate-control" type="{http://www.tmdd.org/303/messages}Gate-request-command"/&gt;
...
@XmlType(name = "GateControlSchedule", propOrder = {
    "deviceControlScheduleHeader",
    "gateControl",
    "any"
})
public class GateControlSchedule
    implements Serializable
{
    ...
    @XmlElement(name = "gate-control", required = true)
