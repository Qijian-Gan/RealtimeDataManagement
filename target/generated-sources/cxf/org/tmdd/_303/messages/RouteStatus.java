 ...
 *         &lt;element name="route-status-list"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence maxOccurs="255"&gt;
 *                   &lt;element name="route" type="{http://www.tmdd.org/303/messages}RouteStatusList"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "route-status-list", required = true)
    protected RouteStatus.RouteStatusList routeStatusList;
    ...
    /**
     * Gets the value of the routeStatusList property.
     * 
     * @return
     *     possible object is
     *     {@link RouteStatus.RouteStatusList }
     *     
     */
    public RouteStatus.RouteStatusList getRouteStatusList() {
        return routeStatusList;
    }

    /**
     * Sets the value of the routeStatusList property.
     * 
     * @param value
     *     allowed object is
     *     {@link RouteStatus.RouteStatusList }
     *     
     */
    public void setRouteStatusList(RouteStatus.RouteStatusList value) {
        this.routeStatusList = value;
    }
    ...
    public static class RouteStatusList
        implements Serializable
    {

        private final static long serialVersionUID = -1L;
        @XmlElement(required = true)
        protected List<org.tmdd._303.messages.RouteStatusList> route;
         ...
         * {@link org.tmdd._303.messages.RouteStatusList }
         * 
         * 
         */
        public List<org.tmdd._303.messages.RouteStatusList> getRoute() {
            if (route == null) {
                route = new ArrayList<org.tmdd._303.messages.RouteStatusList>();
            }
            return this.route;
        }
